...
Short write-ups of backend engineering patterns, each with a working Python implementation
and a note on when to actually reach for it (and when not to). Added incrementally as I
study or apply them — not a tutorial series, a running notebook.
